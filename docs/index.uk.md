...
- Великі плитки галереї тепер використовують підтримуване камерою **1024-px resize-превʼю**, а мала 160×120 thumbnail залишається резервним варіантом.
- Новий cache identity `grid1024` не дозволяє після оновлення використовувати старі низькоякісні мініатюри з кешу.
- Повноекранний перегляд тепер спочатку використовує **`get_screennail.cgi`** для швидшого високоякісного превʼю, а за потреби переходить на попередній **resize 1920**.
